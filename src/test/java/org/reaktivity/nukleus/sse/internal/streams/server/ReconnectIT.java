...
public class ReconnectIT
{
    private final K3poRule k3po = new K3poRule()
        .addScriptRoot("net", "org/reaktivity/specification/nukleus/sse/streams/network/reconnect")
        .addScriptRoot("app", "org/reaktivity/specification/nukleus/sse/streams/application/reconnect");
