...
public class ChallengeIT
{
    private final K3poRule k3po = new K3poRule()
            ...
            .addScriptRoot("client", "org/reaktivity/specification/sse/challenge")
            .addScriptRoot("server", "org/reaktivity/specification/nukleus/sse/streams/challenge");;
    ...
    @Specification({
        ...
        "${client}/respond.to.challenge/request",
        "${server}/respond.to.challenge/response" })
