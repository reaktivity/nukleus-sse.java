...
public class TimestampIT
{
    private final K3poRule k3po = new K3poRule()
        .addScriptRoot("net", "org/reaktivity/specification/nukleus/sse/streams/network/timestamp")
        .addScriptRoot("app", "org/reaktivity/specification/nukleus/sse/streams/application/data")
        .addScriptRoot("appType", "org/reaktivity/specification/nukleus/sse/streams/application/type");
